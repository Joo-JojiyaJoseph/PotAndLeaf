    ...
    <div className="grid min-h-screen bg-surface lg:grid-cols-[1.1fr_1fr]">
      ...
      <main className="relative flex flex-col">
        ...
        <div className="flex flex-1 items-center justify-center px-6 py-10 sm:px-10 lg:px-16">
          <div className="pl-rise w-full max-w-[380px]">
            <h2 className="text-[32px] font-semibold leading-tight text-ink">Welcome back</h2>
            ...
            <form onSubmit={onSubmit} className="mt-7 space-y-4">
              <label className="block space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-12 w-full rounded-xl border border-line bg-surface pl-11 pr-3 text-sm placeholder:text-faint focus:border-leaf/40 focus:outline-none focus:ring-2 focus:ring-leaf/25"
                  />
                </div>
              </label>
              ...
              <label className="block space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="h-12 w-full rounded-xl border border-line bg-surface pl-11 pr-11 text-sm placeholder:text-faint focus:border-leaf/40 focus:outline-none focus:ring-2 focus:ring-leaf/25"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={submitting}
                className="group flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-leaf font-medium text-white transition-all hover:bg-leaf-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-leaf/40 disabled:opacity-60"
              >
