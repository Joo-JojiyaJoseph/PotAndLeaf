...
class RoleController extends Controller
{
    ...
    public function index(Request $request, Team $current_team): Response
    {
        ...
        return Inertia::render('roles/index', [
            ...
            'roles'   => RoleResource::collection($this->roles->list($current_team->id, $filters)),
            'filters' => $filters,
        ]);
    }
    ...
    {
        $role = $this->roles->create($current_team->id, $request->validated());
    ...
    {
        $restored = $this->roles->restore($current_team->id, $role);
