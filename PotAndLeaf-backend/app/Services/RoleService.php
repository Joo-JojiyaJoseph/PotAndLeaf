...
class RoleService
{
    ...
    {
        return $this->roles->paginateForCompany($companyId, $filters);
    }

    /** @param array<string,mixed> $data */
    public function create(int|string $companyId, array $data): Role
    {
        return $this->createRole->handle($companyId, $data);
    }
    ...
    {
        return $this->roles->restore($companyId, $id);
    }
}
